                    ...
                    <div class="card-body p-3 py-2">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td  class="text-center">{{ $priceDay != 0 ? 'Rp'.number_format($priceDay, 0, ',', '.') : 'Belum Disetel' }}</td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{ $priceWeek != 0 ? 'Rp'.number_format($priceWeek, 0, ',', '.') : 'Belum Disetel' }}</td>
                                <td class="text-center">
                                    <div class="btn-group">
                                    <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modalPrice"
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{ $priceMonth != 0 ? 'Rp'.number_format($priceMonth, 0, ',', '.') : 'Belum Disetel' }}</td>
                                <td class="text-center">
                                    <div class="btn-group">
                                    <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modalPrice"
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{ $priceYear != 0 ? 'Rp'.number_format($priceYear, 0, ',', '.') : 'Belum Disetel' }}</td>
                                <td class="text-center">
                                    <div class="btn-group">
                                    <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modalPrice"
